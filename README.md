...
- [File ingestion demo](www.useparagon.com/use-case/workflows/file-ingestion)
- [Permission ingestion demo](www.useparagon.com/use-case/workflows/permissions-ingestion)
- [CRM sync demo](www.useparagon.com/use-case/workflows/real-time-bidirectional-crm-sync)
- [Sending notifications demo](www.useparagon.com/use-case/workflows/slack-teams-notifications)
- [File picker demo](www.useparagon.com/use-case/workflows/file-upload-picker)
- [Agentic actions demo](www.useparagon.com/use-case/workflows/agentic-actions)
### 🌞 Industry Specific Use Case Demos 
- [Meeting Assistant Use Case](www.useparagon.com/use-case/demo/ai-meeting-assistant)
- [AI SDR](www.useparagon.com/use-case/demo/ai-sdr)
- [AI Customer Service Agent](www.useparagon.com/use-case/demo/ai-customer-service-agent)
- [Enterprise Search](www.useparagon.com/use-case/demo/enterprise-search)
